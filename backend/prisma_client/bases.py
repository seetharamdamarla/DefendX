...
class BaseScan(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Scan']] = 'Scan'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.ScanActions[_PrismaModelT]':
        from .client import get_client

        return actions.ScanActions[_PrismaModelT](client or get_client(), cls)
